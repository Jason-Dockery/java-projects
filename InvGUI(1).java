...
public class InvGUI extends JFrame implements ActionListener{
	...
	InvGUI() {
		...
		jl4.setForeground(new Color(255,0,0));
				// Fourth JTextfield
		jtf4 = new JTextField(30); jp2.add(jtf4); jtf4.setEditable(true); 
	 ...
	 void saveFile() {
		try {
			...
			System.out.println("unspecified null exception during object save");
			ne.printStackTrace();
		}
			}
	 @Override
